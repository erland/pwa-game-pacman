...
const MAZE_ROWS = [
  ...
  '2222220220200000020220222222',
  '0000000000200000020000000000',
  '2222220220200000020220222222',
...
const SPAWNS = [
  ...
  { id: 270, name: 'blinky', col: 13, row: 14 },
  { id: 271, name: 'pinky', col: 13, row: 15 },
  { id: 272, name: 'inky', col: 11, row: 15 },
  { id: 273, name: 'clyde', col: 15, row: 15 },
  { id: 274, name: 'fruit', col: 13, row: 17 },
];

const TRIGGERS = [
  { id: 275, name: 'door', type: 'ghostDoor', col: 13, row: 12, widthTiles: 2, heightTiles: 1 },
  { id: 276, name: 'left', type: 'tunnel', col: 0, row: 14 },
  { id: 277, name: 'right', type: 'tunnel', col: 27, row: 14 },
];
